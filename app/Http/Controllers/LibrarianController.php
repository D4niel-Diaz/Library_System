...
class LibrarianController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            'name' => 'required',
            'email' => 'required|email|unique:librarians', // Added email validation and uniqueness
            'phone' => 'required',
        ]);
    ...
    {
        return view('librarians.show', compact('librarian')); // Added return statement
    }
    ...
    public function update(Request $request, Librarian $librarian)
    {
        $request->validate([
            'name' => 'required',
            'email' => 'required|email|unique:librarians,email,'.$librarian->id, // Added validation for update
            'phone' => 'required',
        ]);
    ...
    {
        $librarian->delete();
        return redirect()->route('librarians.index')->with('success', 'Librarian deleted successfully!'); // Fixed typo in success message
    }
}